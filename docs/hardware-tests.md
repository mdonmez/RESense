...
Live fan temperature and RPM are not compared during restoration because they naturally change. Fan mode and custom control state, keyboard state, operation mode, display state, and sound preset are compared.
